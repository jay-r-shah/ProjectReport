...
\usepackage{subfig}
\usepackage[pdfauthor={Jay Shah},pdftitle={Online optimization for process scheduling},pdfkeywords={Scheduling, Optimization, MILP},pdfsubject={MS Project Report}]{hyperref} %use [hidelinks] 
